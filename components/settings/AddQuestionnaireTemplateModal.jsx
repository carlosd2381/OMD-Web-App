// FILE: src/components/settings/AddQuestionnaireTemplateModal.jsx (No Changes)
...
function AddQuestionnaireTemplateModal({ isOpen, onClose, onTemplateAdded }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
      <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-3xl">
        <h2 className="text-2xl font-bold text-[var(--color-brand-brown)] mb-6">New Questionnaire Template</h2>
...
export default AddQuestionnaireTemplateModal;